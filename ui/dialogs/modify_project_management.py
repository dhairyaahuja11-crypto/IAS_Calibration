...
class ModifyProjectDialog(QDialog):
    ...
    def build_ui(self):
        ...
        form.addWidget(QLabel("instrument:"), 0, 4)
        self.instrument_combo = QComboBox()
        self.instrument_combo.setEditable(True)
        form.addWidget(self.instrument_combo, 0, 5)
    ...
    def populate_data(self):
        ...
        self.instrument_combo.setCurrentText(decode_if_bytes(self.project_data.get('instrument', '')))
    ...
    def _sync_instrument_from_samples(self):
        ...
        for sample in self.project_samples:
            ...
            if value and value not in values:
                values.append(value)
        self.instrument_combo.setCurrentText(", ".join(values))
